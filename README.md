 ...
 │   █ █ █ █ █ █ █ █      │  TTS  ██████░░░░▓▓▓▓▓▓  30/ 80/150ms  │
 │   █ █ █ █ █ █ █ █      │                                       │
 │   (equalizer)          │  ■ avg  ■ p95  ■ max                  │
 │                        │                                       │
 │                        │  Tokens: 1,234 prompt / 567 comp      │
 │                        │  TTS chars: 2,890                     │
 ├────────────────────────┴───────────────────────────────────────┤
 │  Agent: paty  │  Uptime: 2m 34s  │  Press q to quit            │
 └────────────────────────────────────────────────────────────────┘
A voice assistant focused on self-hosting.
## Features
1. Free forever. PATY is your personal assistant hosted on your hardware. No limits.
1. Privacy first. Your data never leaves your computer.
1. Bolts included. PATY aims to be one-click deploy for heterogenous environments (linux/mac/mixed).
1. Control your smarthome. Make scheduling decisions. It's Openclaw but good. 

Try using PATY to make calls.
```
